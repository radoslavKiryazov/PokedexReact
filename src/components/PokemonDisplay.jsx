    ...
    return (
        <div className="flex flex-row space-x-5 w-[1300px] h-[550px]  justify-center items-center font-pokemonName" key={selectedPokemon.id}>
            <div className="flex flex-col w-[620px] h-[540px] space-y-1 justify-center items-center">
                <PokemonInfo id={selectedPokemon.id} name={selectedPokemon.name} height={formatHeight(selectedPokemon.height)} weight={formatWeight(selectedPokemon.weight)} pokeimage={selectedPokemon.sprites.other["official-artwork"].front_default} blurb={blurb} colorVariant={colorVariant}/>
